...
export const INITIAL_ASSETS: Asset[] = [
  {
    ...
    current_rarity: Rarity.COMMON, // La rareza se recalculará tras el sync
    lifecycle_stage: LifecycleStage.MONETIZATION,
    created_at: Date.now() - (40 * 24 * 60 * 60 * 1000),
    is_collection: false,
    pins: [] // Los pines se poblarán desde la API de Pinterest
  },
  {
    sku_id: 'SKU-00102',
...
<span class="text-yellow-400 font-bold">LECTURA Y DIAGNÓSTICO:</span>
  <span class="text-white">sync pinterest</span>       : Sincroniza todos los pines y analíticas desde la API v5.
